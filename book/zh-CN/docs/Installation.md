...
一些主要的依赖项包括：
- [TensorFlow](/book/en-US/Background-TensorFlow.md)
- [Jupyter](/book/en-US/Background-Jupyter.md)

### Windows 用户

如果您是刚接触 Python 和 TensorFlow 的 Windows 用户，请遵循[此指南](/book/en-US/Installation-Windows.md)来设置 Python 环境。
...
[该指南](/book/en-US/Using-Docker.md)进行操作。
